...
def obterDiagonal():
    ...
    while numLinha <= 10:  # Se usa conteúdo da diagonal composta pelas 10 linhas superiores
        ...
        for t in matriz[numLinha][inicioRange:finalRange]:
            diagonal.append(t)
        finalRange -= 1  # Move o final do intervalo, pois é diagonal (linha 0 - final 10, linha 1 - final 9,...)
