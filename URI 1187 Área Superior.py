...
def obterArea():
    ...
    numLinha = 0  # Linha dá qual se está obtendo valores
    area = []  # Lista com todos os valores da área
    while numLinha <= 4:  # Se usa conteúdo da área composta pelas 4 linhas superiores
        ...
        for t in matriz[numLinha][inicioRange:finalRange + 1]:
            area.append(t)
        inicioRange += 1  # Move o início do intervalo, seguindo a figura (linha 0 - início 1, linha 2 - início 2,...)
        finalRange -= 1  # Move o final do intervalo, seguindo a figura (linha 0 - final 10, linha 1 - final 9,...)
